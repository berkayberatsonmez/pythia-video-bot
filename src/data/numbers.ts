...
export const NUMBERS: NumberContent[] = [
  ...
  },
  {
    ...
    title: "SONSUZ DÖNGÜ",
    meanings: [
      { title: "YENİ DÖNGÜ", desc: "Bir şey bitti, yenisi\nbaşlıyor. Sıfır noktasındasın —\nher şey mümkün." },
      { title: "BİRLİK", desc: "Evrenle bir olduğun\nbir an. İlahi enerjiyle\nbağın güçleniyor." },
      { title: "SONSUZ POTANSİYEL", desc: "Önünde boş bir tuval var.\nNe çizersen o olacak,\nkorkma." },
    ],
    questionTitle: "000 GÖRÜNCE",
    questionBody: "neye sıfırdan\nbaşlamak istiyorsun?",
    questionFooter: "evren temiz bir sayfa açtı",
    hashtag: "#melekSayıları",
  },
  {
    id: "a717",
    ...
    title: "RUHSAL ŞANS",
    meanings: [
      { title: "DOĞRU YOL", desc: "Ruhsal yolculuğunda\ndoğru yoldasın. Sezgilerin\nseni iyi yönlendiriyor." },
      { title: "ŞANS", desc: "Olumlu düşüncelerin\nşansa dönüşüyor. Pozitif\nkal, ödül geliyor." },
      { title: "BİLGELİK", desc: "Öğrendiklerin meyve\nveriyor. Artık başkalarına\nilham olabilirsin." },
    ],
    questionTitle: "717 GÖRÜNCE",
    questionBody: "hangi sezgine\ngüvenmen gerekiyor?",
    questionFooter: "ruhun doğru yolda",
    hashtag: "#melekSayıları",
  },
  {
    id: "a818",
    ...
    title: "BOLLUK & GÜÇ",
    meanings: [
      { title: "BEREKET", desc: "Maddi bir kapı açılıyor.\nFinansal bolluk yolda,\nhazır ol." },
      { title: "GÜÇ", desc: "İçindeki güce sahip çık.\nKendi gerçeğini yaratacak\nkapasiten var." },
      { title: "DÖNGÜ SONU", desc: "Bir maddi zorluk\nkapanıyor. Rahat bir\ndönem başlıyor." },
    ],
    questionTitle: "818 GÖRÜNCE",
    questionBody: "hangi bolluğa\nhazırsın?",
    questionFooter: "güç ve bereket bir arada",
    hashtag: "#melekSayıları",
  },
  {
    id: "a1010",
    ...
    title: "İLERLE",
    meanings: [
      { title: "HİZALANMA", desc: "Düşüncelerin ve eylemlerin\naynı yönde. Tam da olman\ngereken yerdesin." },
      { title: "GELİŞİM", desc: "Ruhsal olarak\nyükseliyorsun. Konfor\nalanından çık, büyü." },
      { title: "İLERLE", desc: "Tereddüt etme.\nEvren 'devam et' diyor,\nyol açık." },
    ],
    questionTitle: "1010 GÖRÜNCE",
    questionBody: "hangi adımı atmaktan\nçekiniyorsun?",
    questionFooter: "evren ilerlemeni istiyor",
    hashtag: "#melekSayıları",
  },
  {
    id: "a1212",
    ...
    title: "RUHSAL BÜYÜME",
    meanings: [
      { title: "DENGE", desc: "Hayatın dengeleniyor.\nKaos yerini huzura\nbırakıyor." },
      { title: "BÜYÜME", desc: "Ruhsal bir sıçrama\nyapıyorsun. Eski sen\ngeride kalıyor." },
      { title: "GÜVEN", desc: "Evrene güven.\nSeni doğru yöne\ntaşıyor, bırak." },
    ],
    questionTitle: "1212 GÖRÜNCE",
    questionBody: "neyin akışına\nbırakman gerekiyor?",
    questionFooter: "ruhun büyüyor",
    hashtag: "#melekSayıları",
  },
];
